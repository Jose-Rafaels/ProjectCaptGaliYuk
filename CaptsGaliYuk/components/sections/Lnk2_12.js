...
export default function Lnk2_12() {
    return (
        <>
                            ...
                            <div className="row justify-content-center">
                                <div className="col-md-11 col-lg-9">
                                    <div className="section-title wow fadeInUp mb-60">
                                        {/* Title */}
                                        <h2 className="s-50 w-700">Affordable solutions for all your creativity needs</h2>
                                        {/* Text */}
                            ...
                            <div className="row justify-content-center">
                                <div className="col">
                                    <div className="bc-5-img bc-5-tablet img-block-hidden video-preview wow fadeInUp">
                                        ...
                                        <VideoPopup style={2}/>
                                        {/* Preview Image */}
                                        <img className="img-fluid" src="/images/tab-galiyuk.jpg" alt="content-image" />
                                    </div>
                                </div>
                            </div>
