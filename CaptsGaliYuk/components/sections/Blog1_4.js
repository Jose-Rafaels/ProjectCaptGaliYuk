...
export default function Blog1_4() {
    return (
        <>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 col-lg-4">
                            <div id="bp-1-1" className="blog-post wow fadeInUp">
                                ...
                                <div className="blog-post-img mb-35">
                                    <img className="img-fluid r-16" src="/images/blog/post-galiyuk-img-02.jpg" alt="blog-post-image" />
                                </div>
                                {/* BLOG POST TEXT */}
                        ...
                        <div className="col-md-6 col-lg-4">
                            <div id="bp-1-2" className="blog-post wow fadeInUp">
                                {/* BLOG POST IMAGE */}
                                <div className="blog-post-img mb-35">
                                    <img className="img-fluid r-16" src="/images/blog/post-galiyuk-img-01.jpg" alt="blog-post-image" />
                                </div>
                                {/* BLOG POST TEXT */}
                                <div className="blog-post-txt">
                                    {/* Post Tag */}
                        ...
                        <div className="col-md-12 col-lg-4">
                            <div id="bp-1-3" className="blog-post wow fadeInUp">
                                {/* BLOG POST IMAGE */}
                                <div className="blog-post-img mb-35">
                                    <img className="img-fluid r-16" src="/images/blog/post-galiyuk-img.jpg" alt="blog-post-image" />
                                </div>
                                {/* BLOG POST TEXT */}
                                <div className="blog-post-txt">
                                    {/* Post Tag */}
