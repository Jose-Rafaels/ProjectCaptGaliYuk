                        ...
                        <div className="row justify-content-center">
                            <div className="col-md-10 col-lg-9 col-xl-10">
                                <div className="hero-12-txt color--white wow fadeInUp">
                                    {/* Title */}
                                    <h2 className="s-62 w-700">Temukan kemudahan untuk layanan penggalian Anda</h2>
                                    {/* Text */}
                                    <p className="s-22">Menyediakan layanan gali yang komprehensif untuk kebutuhan proyek Anda.</p>
                                    {/* Button */}
                        ...
                        <div className="row">
                            <div className="col">
                                <div className="hero-12-img video-preview wow fadeInUp">
                                    ...
                                    <VideoPopup style={1}/>
                                    {/* Preview Image */}
                                    <img className="img-fluid" src="/images/dashboard-galiyuk.jpg" alt="hero-image" />
                                </div>
                            </div>
                        </div>	{/* END HERO IMAGE */}
                    </div>    {/* End container */}
