...
export default function Lnk1_12() {
    return (
        <>
            <section id="lnk-1" className="bg--white-300 py-100 ct-01 content-section division">
                    ...
                    <div className="row d-flex align-items-center">
                        ...
                        <div className="col-md-6 order-last order-md-2">
                            <div className="txt-block left-column wow fadeInRight">
                                {/* Section ID */}
                                <span className="section-id">Dari yang Kosong menjadi Luar Biasa</span>
                                {/* Title */}
                                <h2 className="s-46 w-700">Graphic design with a personal touch</h2>
                                {/* Text */}
                                ...
                                {/* Small Title */}
                                <h5 className="s-24 w-700">Every pixel counts</h5>
                                {/* CONTENT BOX #1 */}
                        ...
                        <div className="col-md-6 order-first order-md-2">
                            <div className="img-block right-column wow fadeInLeft">
                                <img className="img-fluid" src="/images/img-galiyuk.jpg" alt="content-image" />
                            </div>
                        </div>
