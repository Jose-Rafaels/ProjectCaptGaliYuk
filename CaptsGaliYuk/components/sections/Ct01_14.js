...
export default function Ct01_14() {
    return (
        <>
                    ...
                    <div className="row d-flex align-items-center">
                        ...
                        <div className="col-md-6 order-last order-md-2">
                            <div className="txt-block left-column wow fadeInRight">
                                {/* Section ID */}
                                <span className="section-id">Brand New Design</span>
                                {/* Title */}
                                <h2 className="s-46 w-700">Wujudkan ide Anda dengan GaliYuk</h2>
                                {/* Text */}
                                ...
                                {/* Small Title */}
                                <h5 className="s-24 w-700">Creative and practical</h5>
                                {/* List */}
                        ...
                        <div className="col-md-6 order-first order-md-2">
                            <div className="img-block right-column wow fadeInLeft">
                                <img className="img-fluid" src="/images/img-galiyuk-04.jpg" alt="content-image" />
                            </div>
                        </div>
