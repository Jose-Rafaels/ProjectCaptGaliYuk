    ...
    return (
        <>
            ...
            {style === 3 &&
                ...
                <a onClick={() => setOpen(true)} className="video-popup2 btn r-04 btn--tra-black hover--violet-100">See Bagaimana itu bekerja
                </a>
            }
            {style === 4 &&
                <a onClick={() => setOpen(true)} className="video-popup2 btn r-04 btn--theme hover--tra-black ico-20 ico-right">See Bagaimana itu bekerja <span className="flaticon-play" />
                </a>
            }
            {style === 5 &&
                <a onClick={() => setOpen(true)} className="video-popup2 btn r-04 btn--tra-black hover--theme ico-20 ico-right">
                    See Bagaimana itu bekerja <span className="flaticon-play" />
                </a>
            }
