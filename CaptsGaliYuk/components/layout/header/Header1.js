            ...
            <header id="header" className={`tra-menu white-scroll ${headerCls ? headerCls : ""}`}>
                <div className="header-wrapper">
                    ...
                    <div className="wsmobileheader clearfix">
                        <span className="smllogo"><img src="/images/logo-gali-black.png" alt="mobile-logo" /></span>
                        ...
                        <div className="wsmainwp clearfix">
                            ...
                            <div className="desktoplogo">
                                <Link href="#hero-1" className="logo-black">
                                    <img className="light-theme-img" src="/images/logo-gali-black.png" alt="logo" />
                                    <img className="dark-theme-img" src="/images/logo-gali-black.png" alt="logo" />
                                </Link>
                            </div>
                            {/* HEADER WHITE LOGO */}
                            <div className="desktoplogo">
                                <Link href="#hero-1" className="logo-white"><img src="/images/logo-gali-black.png" alt="logo" /></Link>
                            </div>
                            {/* MAIN MENU */}
