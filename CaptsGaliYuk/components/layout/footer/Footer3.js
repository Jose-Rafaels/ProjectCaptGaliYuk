                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-3">
                            <div className="footer-info">
                                <img className="footer-logo" src="/images/logo-gali-black.png" alt="footer-logo" />
                                <img className="footer-logo-dark" src="/images/logo-gali-black.png" alt="footer-logo" />
                            </div>
                        </div>
                        {/* FOOTER LINKS */}
                        <div className="col-sm-4 col-lg-3 col-xl-2">
                            <div className="footer-links fl-1">
                                ...
                                <ul className="foo-links clearfix">
                                    ...
                                    <li>
                                        <p><Link href="/Testimoni">Customers</Link></p>
                                    </li>
                                    <li>
                        ...
                        <div className="row row-cols-1 row-cols-md-2 d-flex align-items-center">
                            ...
                            <div className="col">
                                <div className="footer-copyright">
                                    <p className="p-sm">© 2023 GaliYuk. <span>All Rights Reserved</span></p>
                                </div>
                            </div>
                            {/* FOOTER SOCIALS */}
                            <div className="col">
