            ...
            <ul className="wsmenu-list nav-theme">
                ...
                <li aria-haspopup="true">
                    ...
                    <ul className="sub-menu" style={{ display: `${isActive.key == 1 ? "block" : "none"}` }}>
                        <li aria-haspopup="true"><Link href="#lnk-1">Mengapa GaliYuk?</Link></li>
                        <li aria-haspopup="true"><Link href="#lnk-2">Integrasi</Link></li>
                        <li aria-haspopup="true"><Link href="#lnk-3">Bagaimana itu bekerja</Link></li>
                        <li aria-haspopup="true"><Link href="#features-2">Solusi Terbaik</Link></li>
                        <li aria-haspopup="true"><Link href="#reviews-1">Testimoni</Link></li>
                    </ul>
                </li>
                        ...
                        <div className="container">
                            <div className="row">
                                ...
                                <ul className="col-md-12 col-lg-3 link-list">
                                    ...
                                    <li><Link href="/reviews">Testimoni</Link></li>
