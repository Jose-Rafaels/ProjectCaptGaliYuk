                            ...
                            <div className="row justify-content-center">
                                <div className="col-md-10 col-lg-9">
                                    <div className="section-title mb-70">
                                        ...
                                        {/* Text */}
                                        <p className="s-21">Menyediakan layanan gali yang komprehensif untuk kebutuhan proyek Anda.</p>
                                    </div>
                                </div>
                            </div>
                            {/* IMAGE BLOCK */}
                            ...
                            <div className="row justify-content-center">
                                <div className="col-md-10 col-lg-9">
                                    <div className="section-title mb-80">
                                        {/* Title */}
                                        <h2 className="s-52 w-700">Semuanya di Satu Tempat</h2>
                                        {/* Text */}
                        ...
                        <div className="container">
                            ...
                            <div className="row justify-content-center">
                                <div className="col-md-10 col-lg-9">
                                    <div className="section-title mb-70">
                                        {/* Title */}
                                        <h2 className="s-52 w-700">Explore Integrasi</h2>
                                        {/* Text */}
                                        <p className="s-21 color--grey">Menyediakan layanan gali yang komprehensif untuk kebutuhan proyek Anda.</p>
                                    </div>
                                </div>
