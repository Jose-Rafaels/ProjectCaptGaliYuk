    ...
    return (
        <>
                            ...
                            <div className="bc-1-wrapper bg--white-400 bg--fixed r-16">
                                <div className="section-overlay">
                                    <div className="row d-flex align-items-center">
                                        ...
                                        <div className="col-md-6 order-first order-md-2">
                                            <div className="img-block right-column wow fadeInLeft">
                                                <img className="img-fluid" src="/images/img-galiyuk-02.jpg" alt="content-image" />
                                            </div>
                                        </div>
                                    </div>   {/* End row */}
                            ...
                            <div className="row justify-content-center">
                                <div className="col-md-10 col-lg-9">
                                    <div className="section-title mb-80">
                                        {/* Title */}
                                        <h2 className="s-50 w-700">Semuanya di Satu Tempat</h2>
                                        {/* Text */}
                                        <p className="s-21 color--grey">Menyediakan layanan gali yang komprehensif untuk kebutuhan proyek Anda.</p>
                                    </div>
                                </div>
                                    ...
                                    <div className="col">
                                        <div className="fbox-2 fb-2 wow fadeInUp">
                                            ...
                                            <div className="fbox-txt">
                                                ...
                                                <p>Beragam pilihan ekstensi dan tambahan untuk memperluas kemampuan proyek Anda.</p>
                                            </div>
                                        </div>
                                    </div>	{/* END FEATURE BOX #2 */}
                                    {/* FEATURE BOX #3 */}
			...
			============================================= */}
                    ...
                    {/* Integrasi-1
			============================================= */}
                    <section id="Integrasi-1" className="pt-100 Integrasi-section">
                        <div className="container">
                            {/* SECTION TITLE */}
                            <div className="row justify-content-center">
                                <div className="col-md-10 col-lg-9">
                            ...
                            {/* Integrasi-1 WRAPPER */}
                            <div className="Integrasi-1-wrapper">
                            ...
                            </div>	{/* END Integrasi-1 WRAPPER */}
                            {/* MORE BUTTON */}
                            <div className="row">
                                <div className="col">
                                    <div className="more-btn text-center mt-60 wow fadeInUp">
                                        <Link href="/Integrasi" className="btn btn--tra-black hover--theme">View all Integrasi</Link>
                                    </div>
                                </div>
                            </div>
                        </div>     {/* End container */}
                    </section>	{/* END Integrasi-1 */}
                    {/* FEATURES-5
			============================================= */}
                                    ...
                                    <div className="col-md-6">
                                        <div className="fbox-5 fb-1 gr--smoke r-16 wow fadeInUp">
                                            ...
                                            <div className="fbox-txt order-last order-md-2">
                                                <h5 className="s-26 w-700">Marketing Integrasi</h5>
                                            ...
                                            <div className="fbox-5-img order-first order-md-2">
                                                <img className="img-fluid light-theme-img" src="/images/f_galiyuk-01.jpg" alt="feature-image" />
                                    ...
                                    <div className="col-md-6">
                                        <div className="fbox-5 fb-2 gr--smoke r-16 wow fadeInUp">
                                            ...
                                            <div className="fbox-5-img">
                                                <img className="img-fluid light-theme-img" src="/images/f_galiyuk-02.jpg" alt="feature-image" />
